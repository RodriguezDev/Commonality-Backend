package edu.uci.ics.chrisr6.service.basic.utilities.security;
...
public class Session {
    ...
    private Session(String email) {
        ...
        this.exprTime = new Timestamp(System.currentTimeMillis());
    ...
    public boolean isDataValid() {
        ...
        Timestamp timeoutTime = new Timestamp(lastUsed.getTime());
