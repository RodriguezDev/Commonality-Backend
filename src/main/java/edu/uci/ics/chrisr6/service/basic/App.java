...
import edu.uci.ics.chrisr6.service.basic.configs.Configs;
...
public class App {
    ...
    private void connectToDatabase() {
        ...
        hostName = configs.getDbHostname();
        ...
        String username = "cs122b_db117";
        username = configs.getDbUsername();
        // Set the corresponding password for the above user account
        String password = "11301997";
        ...
        settings = configs.getDbSettings();
    ...
    private void initHTTPServer() {
        ...
        try {
            ...
            ResourceConfig rc = new ResourceConfig().packages("edu.uci.ics.chrisr6.service.basic.resources");
